---
title: "MDMA-терапія при ПТСР: чому FDA сказала «ні» у 2024 і що показує наука у 2026"
slug: "mdma-terapiya-ptsr-fda-vidmova-2024-lykos-mapp2-2026-pe-cpt"
date: "2026-08-05"
type: "research"
lang: "ua"
tags:
...
- "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC11564115/"
...
- "https://icer.org/assessment/ptsd-2024/"
- "https://pubmed.ncbi.nlm.nih.gov/41825162/"
- "https://www.medrxiv.org/content/10.64898/2026.03.27.26349536v1.full"
- "https://www.acpjournals.org/doi/10.7326/M23-2757"
- "https://cms.law/en/ukr/legal-updates/ukrainian-health-ministry-supports-use-of-psychedelic-assisted-therapy"
- "https://www.drugscience.org.uk/ukraine-psychedelic-research"
- "https://www.fiercebiotech.com/biotech/lykos-accepts-fdas-view-reviving-mdma-treatnents-fortunes-requires-fresh-trial"
source_names:
- "Nature Medicine (Mitchell et al., 2023)"
- "FDA Complete Response Letter (via Psychiatric Times, 2025)"
- "MAPS Public Release of CRL (2025)"
- "HCPLive analysis of FDA CRL"
- "ICER Final Evidence Report on PTSD (2024)"
- "European Neuropsychopharmacology (Fares-Otero et al., 2026)"
- "medRxiv Living Systematic Review (2026)"
- "VA/DoD Clinical Practice Guideline for PTSD (2023) via Annals of Internal Medicine"
- "CMS Law - Ukrainian MoH rescheduling analysis"
- "Drug Science - Ukraine Psychedelic Research"
- "Fierce Biotech - Lykos restructuring"
image: ""
tg_post: |
 <b>Фаза 3 показала мінус 23,7 бала за шкалою ПТСР - але FDA все одно сказала «ні» MDMA-терапії.</b>
...
MDMA - психоактивна речовина з дуже помітними ефектами. За аналізом Institute for Clinical and Economic Review (ICER, 2024), близько **94% учасників групи MDMA** правильно вгадали, що отримали активну речовину, і **76% групи плацебо** зрозуміли, що були у контрольній ([ICER Final Report](https://icer.org/assessment/ptsd-2024/)).
...
FDA у своєму листі перерахувала ще кілька претензій: неповне звітування про серцево-судинні побічні ефекти, етичне порушення в попередньому дослідженні MAPP1 (сексуальне порушення терапевтом), неможливість відокремити ефект речовини від ефекту психотерапії ([HCPLive](https://www.hcplive.com/view/fda-releases-crl-detailing-safety-concerns-mdma-assisted-therapy-ptsd)). Регулятор вимагає нове дослідження фази 3 - Lykos скоротила штат на 75% і поки лише планує його ([Fierce Biotech](https://www.fiercebiotech.com/biotech/lykos-accepts-fdas-view-reviving-mdma-treatnents-fortunes-requires-fresh-trial)).

## Що показує свіжий мета-аналіз 2026

Систематичний огляд Fares-Otero та колег у *European Neuropsychopharmacology* (червень 2026) об'єднав 14 досліджень. Стандартизована різниця середніх (SMD) для тяжкості ПТСР становить −1,19 (95% CI −1,95 до −0,42), для функціональних показників - −0,83 ([PubMed 41825162](https://pubmed.ncbi.nlm.nih.gov/41825162/)).

Ефект помітний, але автори чесно позначають загальну впевненість у доказах як «very low» за системою GRADE - через високий ризик bias, малі вибірки й ту саму проблему розсліплення. Живий систематичний огляд (поки що препринт на medRxiv, березень 2026) підтверджує ту саму картину ([medRxiv](https://www.medrxiv.org/content/10.64898/2026.03.27.26349536v1.full)).

## А що з доказовою альтернативою?

Оновлені клінічні рекомендації VA/DoD 2023 року (США) наполегливо рекомендують (strong recommendation) для ПТСР три методи: **Prolonged Exposure (PE)** - терапія тривалою експозицією, **Cognitive Processing Therapy (CPT)** - когнітивна процесингова терапія, і **EMDR** - десенсибілізація та переробка рухами очей ([Annals of Internal Medicine](https://www.acpjournals.org/doi/10.7326/M23-2757)). За PE лише база AHRQ налічує 19 рандомізованих досліджень із високою силою доказів.
...
MDMA залишається у Списку I - легальної терапії немає. У березні 2025 МОЗ України запропонувало проєкт про перенесення психоделіків у категорію для науково-освітнього використання ([CMS Law](https://cms.law/en/ukr/legal-updates/ukrainian-health-ministry-supports-use-of-psychedelic-assisted-therapy); [Drug Science](https://www.drugscience.org.uk/ukraine-psychedelic-research)). Це відкриє шлях до клінічних досліджень, але не до масової терапії.
