...
Оглядове дослідження Granata, Jamnick і Bishop (Sports Medicine, 2018) розділило процес на дві частини:
...
2. **Метод Karvonen (HRR, резерв пульсу)** - точніший за %HRmax. Формула: ((HRmax − HRrest) × 0,6–0,7) + HRrest (Cleveland Clinic).
3. **Формула Maffetone «180−вік»** - популярна, але має слабку доказову базу: число 180 не прив'язане до лактатного порогу і не враховує індивідуальної варіативності HRmax ±10–15 уд/хв (Maffetone & Laursen, 2020).
