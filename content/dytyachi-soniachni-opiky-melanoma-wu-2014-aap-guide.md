...
tg_post: |
  ...
  <a href="https://longlife.faion.net/dytyachi-soniachni-opiky-melanoma-wu-2014-aap-guide/">Читати повністю →</a>
...
**Окуляри** — теж частина набору. Для дитячих очей вибирай категорію 3, з маркуванням UV400 і за стандартом ISO 12312-1 (про критерії якісних УФ-окулярів — у [нашому матеріалі](https://longlife.faion.net/sonyachni-okulyary-kategoriya-3-uv400-iso-12312-1-traven-serpen/)).
...
Якщо ти читала наш [матеріал про солярії](https://longlife.faion.net/solarii-rak-shkiry-britaniya-zaborona-reklamy-iarc-boniol-2026/), цифри звучатимуть знайомо: солярій до 35 років — це +87% ризику меланоми (Boniol 2012), п'ять дитячих опіків — +80% (Wu 2014). Це той самий механізм — УФ-травма у вікно вразливості.

Як перевіряти родимки дитині — за правилом ABCDE (та EFG для вузлових форм) з [нашого травневого огляду](https://longlife.faion.net/melanoma-abcde-efg-vuzlova-bezpihmentna-samoogliad-2026/). Дитячі родимки переважно нешкідливі, але швидко змінювана, асиметрична або «не схожа на інші» родимка — привід показати дерматологу.
