---
title: "Ретатрутид vs семаглутид: що показали фінальні дані TRIUMPH у 2026"
slug: "retatrutyd-vs-semaglutyd-triumph-phase3-2026"
date: "2026-08-05"
type: "research"
lang: "ua"
tags:
...
source_names:
  ...
  - "PR Newswire — TRIUMPH-1 press release"
  - "PR Newswire — TRIUMPH-2/3 press release"
  - "Diabetes, Obesity and Metabolism (Wilding STEP-1 extension 2022)"
  - "PMC — Wilding STEP-1 extension full text"
  - "BioPharma Dive — Retatrutide FDA timeline"
  - "AJMC — TRIUMPH-1 summary"
image: ""
tg_post: |
  <b>Фінальні дані TRIUMPH 2026: ретатрутид дав −25% ваги за 80 тижнів — майже вдвічі більше за семаглутид</b>
  
  У фазі 3 TRIUMPH-1 (n=2 339) потрійний агоніст GLP-1/GIP/глюкагону на дозі 12 мг показав −25% ваги проти −3.9% у плацебо, а в підгрупі з остеоартритом коліна — −28.7% плюс зменшення болю за WOMAC. Але деталі важливі: цифра −25% рахується за treatment-regimen estimand, а ефект плацебо в OA-болю традиційно високий, тож реальна різниця між групами менша, ніж здається на перший погляд.
  
  <a href="https://longlife.faion.net/retatrutyd-vs-semaglutyd-triumph-phase3-2026/">Читати повністю →</a>
  
  <a href="https://t.me/long_life_media">🌿 LongLife Media</a>
---

Привіт! Сьогодні розберемо новий поворот у гонці препаратів проти ожиріння. У 2026 році Eli Lilly оприлюднила фінальні дані фази 3 програми TRIUMPH для ретатрутиду — потрійного агоніста, який діє одразу на рецептори GLP-1, GIP і глюкагону (GLP-1 — гормон, що стимулює виділення інсуліну та подовжує відчуття ситості; GIP — глюкозозалежний інсулінотропний поліпептид, що підсилює інсуліновий відгук; глюкагон — гормон, що прискорює обмін і витрати енергії). 🔬

Цифри вражають, але, як завжди, диявол у деталях.
...
Прямого head-to-head поки немає, тільки непрямі порівняння через плацебо:

| Препарат | Дослідження | Втрата ваги |
|---|---|---|
| Семаглутид 2.4 мг | STEP-1, 68 тиж | −14.9% |
| Тирзепатид 15 мг | SURMOUNT-1, 72 тиж | −20.9% |
| Ретатрутид 12 мг | TRIUMPH-1, 80 тиж | −25.0% |
...
Базова фаза 2 ретатрутиду в NEJM показала подібні −24.2% за 48 тижнів ([Jastreboff et al., NEJM 2023](https://pubmed.ncbi.nlm.nih.gov/37366315/)). Порівняння тирзепатид vs семаглутид ми вже розбирали у [SURMOUNT-5](https://longlife.faion.net/tyrzepatyd-vs-semaglutyd-surmount-5-porivnyannia-vahy/).
...
**По-друге, м'язова маса.** На GLP-1-препаратах до 25–40% втраченої маси припадає на м'язи — про це ми писали [окремо](https://longlife.faion.net/semaglutyd-mязова-masa-step1-sylovi-trenuvannya-bilok/). При більшому калорійному дефіциті ризик щонайменше не менший.

**По-третє, серцева вигода не доведена.** У TRIUMPH-3 відносний ризик MACE-5 (композитна кінцева точка з 5 подій: інфаркт, інсульт, серцева смерть та ін.) склав HR 0.82, але 95% CI 0.55–1.22 — статистичної значущості не досягнуто. Тобто [семаглутид з SELECT](https://longlife.faion.net/glp-1-semaglutide-heart-disease-select-trial/) поки лишається єдиним GLP-1 із доведеним кардіозахистом.

**По-четверте, побічні ефекти.** Діарея 24–34%, нудота 14–28%, тахікардія +5–10 ударів на хвилину, припинення терапії через побічні — до 13.5% на 12 мг.
...
- Якщо думаєш про GLP-1-терапію — говорити з ендокринологом про **зареєстровані** препарати (семаглутид, ліраглутид) і план утримання ваги після курсу.
- Паралельно з будь-яким препаратом — **силові тренування 2–3 рази на тиждень і 1.2–1.6 г білка на кг ваги**, щоб зберегти м'язи.
- Слідкувати за оновленнями TRIUMPH через peer-review публікації, а не через рекламу.

Хоча дані TRIUMPH обнадійливі, це початок історії ретатрутиду, а не її фінал. 🌿

---

*Матеріал має інформаційний характер і не замінює консультацію лікаря. Будь-які рішення щодо медикаментозної терапії ожиріння приймай разом із ендокринологом або сімейним лікарем.*

**Теги:** #ретатрутид #GLP1 #ожиріння #TRIUMPH #семаглутид #тирзепатид

**Категорія:** Медикаменти / Метаболічне здоровʼя