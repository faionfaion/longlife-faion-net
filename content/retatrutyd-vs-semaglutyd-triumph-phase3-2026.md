...
tg_post: |
  ...
  <a href="https://longlife.media/retatrutyd-vs-semaglutyd-triumph-phase3-2026/">Читати повністю →</a>
...
**По-третє, серцева вигода не доведена.** У TRIUMPH-3 відносний ризик MACE-5 (композитна кінцева точка з 5 подій: інфаркт, інсульт, серцева смерть та ін.) склав HR 0.82, але 95% CI 0.55–1.22 — статистичної значущості не досягнуто. Тобто [семаглутид з SELECT](https://longlife.media/glp-1-semaglutide-heart-disease-select-trial/) поки лишається єдиним GLP-1 із доведеним кардіозахистом.
