...
tg_post: |
 ...
 <a href="https://longlife.media/vtrata-slukhu-dementsiia-lancet-achieve-zakhyst-vukh-mozok/">Читати повністю →</a>
...
**2. Соціальна ізоляція.** Людині зі зниженим слухом важче підтримувати розмову → вона починає уникати спілкування → розвивається самотність і депресія → а це вже окремі фактори ризику деменції. До речі, [ми вже писали про те, як соціальні зв'язки впливають на тривалість життя](https://longlife.media/social-connections-longevity-research/) - і ця тема тісно переплітається зі слухом.
...
Ми [вже розглядали стан здорового довголіття в Україні](https://longlife.media/hale-healthy-life-expectancy-ukraine-uk-gbd-2021-who/) і [зв'язок ультраоброблених продуктів із деменцією](https://longlife.media/ultraobrobleni-produkty-dementsiia-kohortni-doslidzhennia/) - втрата слуху додає ще один вимір до профілактики когнітивного здоров'я.
