...
source_names:
  ...
  - "Таблиця порогів ВООЗ тут"
  - "подвійному сліпому РКД (CMAJ, 2012)"
  - "РКД у BMJ (2003)"
  - "дослідження в Blood (2011)"
  - "клінічні рекомендації IRLSSG (2018)"
  - "систематичний огляд щодо спортсменок (2024)"
  - "ізотопне дослідження в Blood (Moretti, 2015)"
  - "двох РКД (Lancet Haematology, Stoffel, 2017)"
  - "дослідженні на жінках з анемією (Haematologica, Stoffel, 2020)"
  - "Мета-аналіз 2025 року (11 РКД, 1014 учасників)"
