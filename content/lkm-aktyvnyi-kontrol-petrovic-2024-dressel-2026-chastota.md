...
source_descriptions:
  - "Систематичний огляд і мета-аналіз 23 РКД; LKM покращує співчуття, позитивні емоції та симптоми лише проти пасивного контролю, а різниці з активним контролем не виявлено"
  - "РКД (n=108, 4 тижні); і LKM, і прогресивна м'язова релаксація знизили самотність без значущої різниці між ними, емпатія не зросла"
  - "18-місячне РКД Age-Well (n=137, вік 65+); і медитація, і вивчення іноземної мови зменшили самотність проти пасивного контролю, різниці між ними не зафіксовано"
  - "Мета-аналіз LKM; помірні ефекти проти пасивного контролю, дані щодо активних контролів визнано непереконливими"
  - "Поперечне опитування досвідчених практиків (n=60); з нижчою тривогою пов'язана частота практики (2–4 дні на тиждень), а не стаж"
  - "РКД-порівняння LKM і mindfulness (MBSR) для тривоги; попередній матеріал, з яким свіжі дані вступають у поправку"
---
