...
tg_post: |
  ...
  <a href="https://longlife.faion.net/shi-dyzain-bakteriofahiv-science-2026-phagoburn-rct-dokazy/">Читати повністю →</a>
...
6 серпня 2026 року в журналі *Science* вийшла робота команди Браяна Хая з Arc Institute та Стенфорду: генеративні мовні моделі Evo 1 та Evo 2 спроєктували з нуля повні геноми бактеріофагів, і частина з них виявилася життєздатною ([Science, DOI 10.1126/science.aec2657](https://www.science.org/doi/10.1126/science.aec2657), [PMID 42561074](https://pubmed.ncbi.nlm.nih.gov/42561074/)). Ми вже писали про цю роботу [тут](https://longlife.faion.net/ai-bakteriofahy-stanford-evo-2-biobezpeka-2026/) — тепер зосередимося на доказах.
...
Модель Evo 2 навчали на 9 трильйонах пар основ ДНК ([Nature](https://www.nature.com/articles/s41586-026-10176-5)), проте послідовності вірусів еукаріотів — тобто тих, що заражають людей і тварин, — з навчальних даних свідомо прибрали. Під час перевірок згенеровані послідовності патогенних для людини вірусних білків виходили фактично випадковими ([Arc Institute](https://arcinstitute.org/news/hie-king-first-synthetic-phage)).

Саймон Кларк, доцент з клітинної мікробіології Редінгського університету, називає дані якісними, але додає: немає гарантії, що кожен, хто спробує повторити подібне, буде так само обережним ([University of Reading](https://www.reading.ac.uk/news/2026/Expert-Comment/Generative-design-of-bacteriophages-expert-comment)). Тобто запобіжники поки що добровільні, а не регуляторні — і це справжня тема дискусії, а не паніки.
...
Систематичний огляд 2025 року зібрав 130 досліджень і 1115 пацієнтів — здебільшого це описи випадків і серії ([Int J Antimicrob Agents](https://www.sciencedirect.com/science/article/abs/pii/S0924857925001256)). Серія зі 100 послідовних випадків персоналізованої фагової терапії (*Nature Microbiology*, 2024) — ретроспективна, без контрольної групи ([PMID 38834776](https://pubmed.ncbi.nlm.nih.gov/38834776/)).
...
- **Приймай антибіотик так, як призначив лікар**, і не починай його «про всяк випадок» при застуді, яку зазвичай спричиняють віруси. Резистентність, яку ми бачимо в ранах, формується зокрема так ([ВООЗ](https://www.who.int/publications/i/item/9789240093461)).
