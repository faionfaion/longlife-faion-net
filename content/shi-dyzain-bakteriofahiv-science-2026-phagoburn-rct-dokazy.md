...
source_descriptions:
  - "Стаття в Science (6.08.2026, DOI 10.1126/science.aec2657): моделі Evo 1 та Evo 2 згенерували з нуля повні геноми фагів на шаблоні ΦX174 — із 285 синтезованих варіантів життєздатними стали 16 (~5,6%)."
  - "PubMed-запис тієї ж роботи (PMID 42561074) — індексація публікації Arc Institute і Стенфорду про фаги, спроєктовані генеративними моделями."
  - "Nature: опис Evo 2 — модель навчали на 9 трильйонах пар основ ДНК, свідомо виключивши з даних послідовності вірусів еукаріотів."
  - "Arc Institute: перевірки безпеки показали, що згенеровані моделлю послідовності патогенних для людини вірусних білків виходять фактично випадковими."
  - "Експертний коментар Редінгського університету: Саймон Кларк оцінює дані як якісні, але наголошує, що запобіжники поки добровільні й не гарантують обережності інших дослідників."
  - "PhagoBurn (Lancet Infectious Diseases, 2019, PMID 30292481): РКД фагової терапії опікових ран із P. aeruginosa — 27 рандомізованих (25 в аналізі); коктейль деградував, доза виявилася на ~4 порядки нижчою, дослідження закрили достроково і воно недостатньо потужне."
  - "Систематичний огляд 2025 року (Int J Antimicrob Agents): 130 досліджень і 1115 пацієнтів, здебільшого описи випадків і серії — контрольованих даних обмаль."
  - "Nature Microbiology (2024): серія зі 100 послідовних випадків персоналізованої фагової терапії — ретроспективна, без контрольної групи."
  - "ВООЗ, перелік пріоритетних бактеріальних патогенів (BPPL 2024) — глобальний орієнтир, які резистентні збудники потребують нових засобів лікування."
  - "Communications Medicine (2025): ретроспективна когорта 73 поранених військових у трьох цивільних лікарнях Сум (січень–квітень 2024) — множинна резистентність у 84,6% ізолятів, A. baumannii 36%, 40% K. pneumoniae стійкі до карбапенемів (PMC12460610)."
  - "The Lancet Infectious Diseases — публікація про масштаб антибіотикорезистентності та інфекцій, релевантна українському воєнному контексту."
  - "Наш попередній матеріал про роботу Стенфорду та Evo 2 і питання біобезпеки — контекст, до якого ця стаття додає розбір доказів."
---
