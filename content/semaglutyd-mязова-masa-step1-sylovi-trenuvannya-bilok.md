...
source_names:
  - "експлораторного аналізу"
  - "Diabetes, Obesity and Metabolism (2024)"
  - "NEJM 2021"
  - "post-treatment аналіз Sandsdal/Jensen у eClinicalMedicine (2024)"
  - "спільний advisory в журналі Obesity"
  - "мета-аналізу Мортона в BJSM (2018)"
...
Пізніший post-treatment аналіз Sandsdal/Jensen у eClinicalMedicine (2024)00054-3/fulltext) показав: через рік після відміни препарату найбільше ваги повернула група «ліки без вправ». Комбінація і просто тренування - утримали результат.
