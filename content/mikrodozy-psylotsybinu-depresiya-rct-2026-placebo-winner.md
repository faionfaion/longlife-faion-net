...
tg_post: |
  ...
  <a href="https://longlife.media/mikrodozy-psylotsybinu-depresiya-rct-2026-placebo-winner/">Читати повністю →</a>
...
У мікродозах цього «сигналу» немає — і магія зникає. Як ми вже [писали про психоделіки проти ПТСР і депресії](https://longlife.media/psylocybin-mdma-ptsr-depresiya-fda-vidmova-2026-vyprobuvannia/), очікування — потужний драйвер результатів у цій сфері.
...
2. **Якщо є симптоми депресії — почни з доказової першої лінії:** когнітивно-поведінкова терапія, SSRI (за призначенням лікаря), регулярні фізичні навантаження (ефект аеробних вправ [підтверджений мета-аналізами](https://longlife.media/vpravy-depresiia-yakist-dokaziv-bmj-meta-analiz-viyna/)).
