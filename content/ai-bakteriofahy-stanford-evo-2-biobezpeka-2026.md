...
source_descriptions:
  - "Дослідження Stanford/Arc Institute: моделі Evo 1 та Evo 2 спроєктували 302 варіанти геному фага, з 285 синтезованих 16 виявилися працездатними (5,3%), частина перевершила дикий тип ΦX174."
  - "Супровідна публікація команди Evo 2: виключення еукаріотичних вірусів з тренувальних даних справді погіршує моделювання людських патогенів — підтвердження дієвості safety-фільтрації."
  - "Пресреліз Stanford: акцент на прикладній користі — швидша розробка індивідуальних фагових терапій проти антибіотикостійких штамів."
  - "Рамковий документ ВООЗ 2022 з відповідального використання наук про життя: не є юридично зобов'язуючим і не містить правил для AI-дизайну геномів."
  - "Аналіз групи Кевіна Есвельта (MIT), січень 2026: 5-рівнева рамка ризиків AI-біобезпеки; скринінг синтезу ДНК має перейти від пошуку схожості до аналізу функції."
  - "NTI: пропозиція managed access до біологічних AI-інструментів — верифікація особи та легітимності запиту як умова доступу."
  - "Спільна заява NTI і Мюнхенської безпекової конференції (лютий 2025) про ШІ та науки про життя: чинні режими не покривають генеративний дизайн геномів."
  - "Науково-популярний розбір експерименту з AI-фагами: пояснює методику генерації геномів і межі інтерпретації результатів."
  - "Оригінальна назва статті у Science про генеративний дизайн бактеріофагів геномними мовними моделями — первинне джерело всіх цифр у тексті."
  - "Аналітика AI-biosecurity (Frontiers in Microbiology, 2026): систематизує сценарії зловживання генеративними біомоделями та вимоги до скринінгу."
  - "Глобальна рамка ВООЗ 2022 з окремою зустріччю стейкхолдерів у грудні 2024: рекомендаційний характер, регуляторна прогалина щодо ШІ зберігається."
  - "Матеріали ВООЗ з антимікробної резистентності: AMR як одна з провідних глобальних загроз здоров'ю та контекст для інтересу до фагової терапії."
---
