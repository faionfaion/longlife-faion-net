...
source_descriptions:
  - "Систематичний огляд і позиційна заява NOF: 20–40% пікової кісткової маси залежить від способу життя; ключові — достатній кальцій (~1000 мг/день) і білок."
  - "Лонгітюдне дослідження: у жінок пік загальної щільності настає ~24 роки, шийки стегна — ~24,8, тобто накопичення завершується у мідл-20-х."
  - "Мета-аналіз 7 РКД (521 жінка 18–45 років): силові й ударні тренування дали +~1,1% щільності шийки стегна (p=0,001) і приріст у поперековому відділі (p=0,04)."
  - "Системний огляд: у молодих жінок остеогенний ефект навантажень менш однозначний, ніж у чоловіків."
  - "Мета-аналіз стрибкових втручань: навіть 10–50 стрибків на день дають остеогенний стимул у шийці стегна."
  - "Настанова Endocrine Society: здоровим дорослим 19–74 років емпіричний прийом вітаміну D не рекомендований — лише при задокументованому дефіциті."
  - "РКД менахінону-7 (K2) — виконане лише на постменопаузальних жінках; для молодих доказів немає."
  - "Позиція ISSN: 3–5 г креатину моногідрату на день безпечні й ефективні."
  - "Огляд у Nutrients: у жінок м'язові запаси креатину на 70–80% менші, тож теоретично відповідь на добавку може бути кращою."
  - "Рекомендація USPSTF: рутинний скринінг щільності кісток не показаний здоровим жінкам до менопаузи."
  - "PubMed Central — відкритий архів повнотекстових біомедичних статей NIH, звідки доступні згадані джерела."
---
...
А от менахінон-7 (K2) - форма вітаміну K, що бере участь у карбоксилюванні кісткових білків - має РКД лише **у постменопаузальних жінок** (Knapen et al., 2013, *Osteoporos Int*). Для 20-тирічних доказів немає - маркетинг тут біжить попереду науки.
