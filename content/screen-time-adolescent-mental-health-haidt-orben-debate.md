...
source_names:
  - "рівень депресивних симптомів і суїцидальних думок різко зріс після 2010 року"
  - "аналіз даних понад 350 000 підлітків"
  - "рандомізоване контрольоване дослідження (РКД) Аллкотта та колег"
  - "написала у *Nature* (2024)"
  - "рекомендаціях 2023 року"
  - "рекомендаціях 2023 року"
  - "міжнародного дослідження HBSC (Health Behaviour in School-aged Children) 2021/2022"
  - "дослідження Вердейна та колег (2015) у *Journal of Experimental Psychology: General*"
  - "дозріває приблизно до 25 років"
