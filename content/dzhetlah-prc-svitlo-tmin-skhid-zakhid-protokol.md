...
tg_post: |
  ...
  <a href="https://longlife.faion.net/dzhetlah-prc-svitlo-tmin-skhid-zakhid-protokol/">Читати повністю →</a>
  
  <a href="https://t.me/long_life_media">🌿 LongLife Media</a>
---

**Категорія:** Сон і циркадні ритми
...
Про сам покроковий протокол повернення з відпустки ми вже писали окремо — [«Джетлаг після відпустки: світло, мелатонін і їжа»](https://longlife.faion.net/dzhetlah-pislya-vidpustky-protokol-svitlo-melatonin-yizha-bbc-2026/). Тут — рівень нижче: чому той протокол влаштований саме так і де він ламається. 🔬

## Спочатку — чи є в тебе взагалі джетлаг

Оглядова стаття Roach і Sargent у журналі *Frontiers in Physiology* (2019) визначає джетлаг як стан, що виникає при перетині **трьох і більше часових поясів** ([огляд](https://pmc.ncbi.nlm.nih.gov/articles/PMC6684967/)). Менше — це «дорожня втома»: інший стан, з іншою причиною (сидіння, зневоднення, шум, недосипання) і з іншим лікуванням — виспатися.
...
Цікава деталь: систематичний огляд Bin і колег у *Sleep Medicine Reviews* (2019) переглянув 13 досліджень немедикаментозних втручань — і головний висновок авторів був саме про це: потрібні роботи, які планують **не тільки світло, а й темряву** ([огляд](https://pubmed.ncbi.nlm.nih.gov/30529430/)).
...
**А от мелатонін має кращий клінічний послужний список.** Кокранівський мета-аналіз Herxheimer і Petrie (2002) охопив 10 рандомізованих контрольованих досліджень; у **дев'яти із десяти** мелатонін — гормон, який сигналить організму про настання темряви, — зменшував прояви джетлагу при перельоті через **5+ поясів**, коли його приймали близько до цільового часу сну в пункті призначення ([мета-аналіз](https://pubmed.ncbi.nlm.nih.gov/11279722/)). Практичні параметри AASM (Morgenthaler та ін., 2007, журнал *Sleep*) дають вчасно призначеному мелатоніну рейтинг «Standard» — найвищий рівень клінічної впевненості ([документ](https://pubmed.ncbi.nlm.nih.gov/18041479/)).
...
Тож точніше формулювання таке: **світло задає напрямок і пояснює механізм, мелатонін має сильніші клінічні випробування**. Систематичний огляд 2024 року в *Cureus* рекомендує комбінацію і свідомо відмовляється називати щось із двох кращим ([огляд](https://pmc.ncbi.nlm.nih.gov/articles/PMC11554432/)) — щоправда, 21 із 23 включених робіт були оглядами, а не RCT, тож вага в нього невелика.
...
Якщо ж тебе більше цікавить не переліт, а домашній ритм — у нас є [гайд про ранкове світло і циркадний ритм](https://longlife.faion.net/rankove-sontse-10-khvylyn-tsyrkadnyi-rytm-protokol/). А якщо в родині школяр, який за літо з'їхав на «нічний» режим, — [розбір соціального джетлагу в дітей 6–12 років](https://longlife.faion.net/sotsialnyi-dzhetlah-dity-6-12-serpen-rezhym-snu-protokol/). 😴
