...
source_descriptions:
  - "Позиційна стаття робочої групи ВООЗ у World Psychiatry: пояснює, чому CSBD внесли до МКХ-11 як розлад контролю імпульсів, а не як залежність — доказів для адиктивної рамки виявилося недостатньо."
  - "Оглядова стаття про контроверсії довкола гіперсексуального розладу: показує, чому APA у 2013 році відхилила запропоновані критерії навіть для секції III DSM-5."
  - "Розробка й валідація опитувальника CSBD-19 на 9 325 респондентах із США, Угорщини та Німеччини; підтверджено п'ятифакторну структуру за доменами МКХ-11 і поріг ≥50 балів."
  - "Валідація короткого скринера BPS на п'яти незалежних вибірках (ветерани США, дві репрезентативні вибірки, поляки); фінальна 5-пунктова версія з α ≈ 0,89–0,90 і порогом ≥4 бали."
  - "International Sex Survey: 82 243 учасники з 42 країн; близько 4,8% у зоні високого ризику CSBD із розкидом 1,6–16,7% залежно від країни, статі та орієнтації."
  - "Дослідження Grubbs et al. в Archives of Sexual Behavior: відчуття власної «залежності» від порно слабко пов'язане з фактичними обсягами споживання, натомість сильно — з моральним несхваленням."
  - "Лонгітюдне дослідження в Clinical Psychological Science: моральна невідповідність передбачає самосприйняття себе як залежного в часі, тоді як частота перегляду пояснює це значно гірше."
  - "Мета-аналіз López-Pinar et al. (2025) щодо ефективності психотерапевтичних і фармакологічних втручань при компульсивній сексуальній поведінці."
  - "Систематичний огляд (Archives of Sexual Behavior, 2023) доказової бази лікування проблемного споживання порно: сукупність досліджень мала, дизайни неоднорідні."
  - "Рандомізоване дослідження Crosby & Twohig: терапія прийняття й відповідальності (ACT) знижувала проблемне споживання порно та пов'язаний дистрес порівняно з контролем."
  - "Критичний аналіз Prause & Binnie у Sexualities: як мова «порнозалежності» поширюється поза доказовою базою і працює радше як моральний, ніж клінічний конструкт."
  - "Робота Prause & Binnie у Sexual Health & Compulsivity: методологічна критика інструментів і досліджень, що заявляють про адиктивну природу споживання порно."
  - "Тематична дискусія в Archives of Sexual Behavior (2024): огляд суперечок довкола CSBD — чи це залежність, розлад контролю імпульсів, чи артефакт моральних оцінок."
  - "Матеріал BBC News (липень 2026): історія британського стрибуна у воду Фредді Вудворда про шість років боротьби з компульсивним споживанням порно."
  - "Офіційний браузер ICD-11 ВООЗ: першоджерело формулювань коду 6C72, п'яти діагностичних доменів, порогу тривалості 6 місяців і застереження щодо морального дистресу."
  - "Crosby & Twohig, Behavior Therapy, 2016 — те саме РКД з ACT-протоколом: значуще зниження перегляду порно та збереження ефекту на подальшому спостереженні."
---
