...
source_descriptions:
  - "Опитування 97 військовослужбовиць ЗСУ (89% з бойовим досвідом), січень 2026: 23% ніколи не отримували бронежилет, 73% з тих, кому видали, назвали вагу 10,5-15,5 кг і крій неприйнятними; задокументовано випадок запалення грудних м'язів і молочних залоз. Вибірка зручна, не репрезентативна."
  - "Bose, Seguí-Gómez, Crandall (2011), ретроспективна когорта на даних США 1998-2008: пристебнуті жінки-водійки мали на 47% вищі шанси важкої травми, ніж пристебнуті чоловіки в порівнюваних аваріях (95% ДІ 28-70%), з надлишком травм грудної клітки і хребта."
  - "Forman et al. (2019) на базі NASS-CDS 1998-2015 (~23 000 лобових аварій, 31 000+ людей): після поправок на тяжкість аварії, вік, зріст, ІМТ і рік випуску авто пристебнуті жінки мали на 73% вищі шанси серйозної травми; тут же Brumbelow і Jermakian (2022) — див. джерело 5."
  - "Abrams і Bass (2024), метод подвійних пар на базі FARS 1975-2020 з підбором за місцем у салоні, типом авто, подушкою, ременем і віком: жінки 20-40 років мали на ~20% вищий ризик загинути (у 2010-2020 роках розрив звузився до ~12%); механізм смерті з цих даних невідомий."
  - "Brumbelow і Jermakian (IIHS, 2022): без поправок жінки втричі частіше зазнають помірних і вдвічі частіше серйозних травм у лобових зіткненнях, але при обмеженні аналізу порівнюваними аваріями й автомобілями більша частина розриву зникає (жінки їздять меншими авто і частіше є стороною, в яку в'їхали); стійким лишається ризик травм нижніх кінцівок — понад у 2,5 раза вищий."
  - "Звіт NHTSA до Конгресу (2026) про статеві відмінності в травматизмі при ДТП і розробку жіночих краш-тест-манекенів; агентство підтверджує надлишок травм нижніх кінцівок, але поширювану цифру «+26% ризику для жінок» у документах NHTSA знайти не вдалося — вона циркулює лише в блогах юрфірм."
  - "Дослідження в Injury Epidemiology про статеві відмінності в структурі й тяжкості травм — підтверджує, що патерни ушкоджень у жінок і чоловіків відрізняються навіть за зіставних обставин."
  - "Публікація в International Journal of Environmental Research and Public Health про професійне здоров'я та ергономіку жінок — невідповідність спорядження і робочих середовищ жіночій антропометрії як чинник ризику."
  - "Дослідження в Applied Ergonomics: захисне й робоче спорядження проєктують за чоловічою антропометрією, тож «жіночі» версії часто є зменшеними копіями, що погіршують посадку, рухливість і розподіл ваги."
  - "Публікація у Frontiers in Sports and Active Living про жіночу фізіологію в навантаженнях і військово-спортивному контексті — дані про жінок систематично бідніші за дані про чоловіків."
  - "Українська правда: репортажі й матеріали про забезпечення військовослужбовиць ЗСУ жіночою формою та бронежилетами і про темпи закупівель."
  - "Kyiv Independent: англомовні репортажі про жінок у ЗСУ, зокрема про брак спорядження, скроєного під жіноче тіло."
  - "EMJ Microbiology & Infectious Diseases: огляд статевих відмінностей в імунній відповіді та перебігу інфекцій — жінки й чоловіки реагують на збудників і терапію по-різному."
  - "Biology of Sex Differences: журнал і дослідження, що документують статеві відмінності на рівні клітин, органів і фармакокінетики, а також системне недопредставлення самиць у доклінічних моделях."
  - "FDA: регуляторний прецедент — виключення жінок дітородного віку з ранніх фаз випробувань (1977) і пізніший перегляд правил; звідси ж перегляд дозування (класичний випадок — золпідем, доза для жінок знижена вдвічі)."
  - "Social Studies of Science: соціологічний аналіз того, як «чоловіче тіло за замовчуванням» закріпилося в стандартах медицини й техніки як норма, а жіноче — як відхилення."
  - "JAMA Network Open: дослідження про статевий склад учасників клінічних випробувань і про різницю в діагностиці й лікуванні жінок і чоловіків."
  - "NIH Revitalization Act (1993): закон, який зобов'язав включати жінок і меншини до клінічних досліджень, фінансованих NIH, і аналізувати результати за статтю — точка відліку для змін."
  - "Neuroscience & Biobehavioral Reviews: огляди статевих відмінностей у нейробіології та про домінування самців у нейронаукових експериментах."
  - "BMJ: публікації про гендерні розриви в діагностиці, лікуванні й клінічних настановах, а також про якість доказової бази щодо жінок."
  - "Journal of the American Heart Association: дані про гірші наслідки серцево-судинних подій у жінок, зокрема пізнішу діагностику та менш агресивне лікування."
  - "VIRGO (Circulation, Єльський університет): проспективне дослідження молодих пацієнтів з інфарктом міокарда — жінки частіше мають нетипові симптоми, довше добираються до допомоги і рідше отримують своєчасне лікування."
  - "Nursing Open: дослідження про розпізнавання симптомів у жінок медперсоналом і про наслідки гендерних упереджень у догляді."
  - "Communications Medicine: сучасні дані про статеві відмінності у відповіді на терапію та про потребу аналізувати клінічні результати з розбивкою за статтю."
  - "STAT News: журналістські розслідування про гендерні прогалини в медичних дослідженнях, дозуванні ліків і клінічних випробуваннях."
  - "Undark: науково-журналістські матеріали про «чоловіче тіло за замовчуванням» у дизайні досліджень і техніки та про повільність виправлень."
  - "Джерело не вказано."
  - "Джерело не вказано."
  - "Джерело не вказано."
  - "Джерело не вказано."
