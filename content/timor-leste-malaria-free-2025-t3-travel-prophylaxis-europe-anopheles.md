...
source_urls:
  ...
  - "https://longlife.faion.net/cyclospora-salaty-vidpustka-diareya-ukhsa-2026-tmp-smx/"
  - "https://longlife.faion.net/who-malaria-coartem-baby-prequalification-infants-ukraine/"
source_names:
...
tg_post: |
  ...
  <a href="https://longlife.faion.net/timor-leste-malaria-free-2025-t3-travel-prophylaxis-europe-anopheles/">Читати повністю →</a>
...
Коротка відповідь: тому що малярія повертається до Європи. У Франції, Італії та Греції у 2022–2025 роках зафіксували локальні випадки. А українці масово подорожують — і завізні випадки в Україні реєструються щороку (за загальною [сторінкою ЦГЗ про профілактику малярії](https://phc.org.ua/news/profilaktika-malyarii-poradi-vidviduvacham-inshikh-krain), щорічна оперативна статистика оновлюється на сайті центру).
...
Стратегія Тимор-Лешті будувалася на кількох простих речах, які ВООЗ описала у [пресрелізі від 24 липня 2025 року](https://www.who.int/news/item/24-07-2025-timor-leste-certified-malaria-free-by-who):
...
Це класична реалізація глобальної рамки ВООЗ, відомої як [T3: Test, Treat, Track](https://www.mmv.org/newsroom/publications/t3-test-treat-track-initiative), запущеної у 2010 році. Дослов­но: тестувати кожен підозрюваний випадок, лікувати кожен підтверджений якісним препаратом, відстежувати кожен через систему нагляду.
...
**Третє — «одіссеївська» малярія.** Заражений комар прилітає у валізі чи літаку з ендемічної країни й кусає когось поруч із аеропортом. У [ретроспективному аналізі 117 автохтонних випадків у Франції за 1995–2022 роки](https://pmc.ncbi.nlm.nih.gov/articles/PMC11484917/), опублікованому в Eurosurveillance, саме такі випадки становили 44%. Причому їх частота подвоїлася: з 1,2 на рік у 1995–2010 до 2,7 на рік з 2011-го.
...
Що стосується локальної передачі, [систематичний огляд по Європі за 1969–2022 роки](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12410179/) фіксує кластери в Греції (спалах на Евроті у 2011-му — 42 випадки *P. vivax*), Мальті, Нідерландах. Для контексту: у 2025-му Європа пережила найбільший в історії спалах чикунгуньї — [1172 випадки у Франції та Італії разом](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12737385/). Модель та сама: клімат + компетентний вектор + завізні випадки.
...
Якщо ти летиш у Субсахарську Африку, Південно-Східну Азію чи тропічну Латинську Америку, найшвидший спосіб не привезти плазмодія — це репеленти, сітка над ліжком і хіміопрофілактика. За [CDC Yellow Book 2026](https://www.ncbi.nlm.nih.gov/books/NBK620970/), основні варіанти виглядають так.
...
Кілька важливих застережень із гайдлайну CDC та [консолідованого гайдлайну ВООЗ від 13 серпня 2025 року](https://www.ncbi.nlm.nih.gov/books/NBK588130/pdf/Bookshelf_NBK588130.pdf):
...
- **Немовлята 2–5 кг** — уже є прекваліфікована ВООЗ форма Coartem Baby для лікування, [про яку ми писали у квітні 2026](https://longlife.faion.net/who-malaria-coartem-baby-prequalification-infants-ukraine/).
...
[ЦГЗ України нагадує](https://phc.org.ua/news/profilaktika-malyarii-poradi-vidviduvacham-inshikh-krain): симптоми зазвичай з'являються через 10–15 днів після укусу, але можуть і через рік — особливо *P. vivax* і *P. ovale*. Класика: гарячка нападами, озноб, пітливість, головний біль, ломота в м'язах.
...
До речі, тиждень тому ми писали про [циклоспору в салатах для тих, хто повертається з Мексики](https://longlife.faion.net/cyclospora-salaty-vidpustka-diareya-ukhsa-2026-tmp-smx/). Це сестринська історія: паразит у їжі vs паразит у комарі, різні механізми — однакова логіка «повернувся і не одужуєш → до інфекціоніста».
