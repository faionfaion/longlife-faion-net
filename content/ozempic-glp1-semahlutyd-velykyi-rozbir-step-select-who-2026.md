...
source_urls:
  ...
  - "https://www.amjmed.com/article/S0002-9343(25"
  - "https://www.thelancet.com/journals/eclinm/article/PIIS2589-5370(26"
source_names:
  ...
  - "LB.ua"
  - "РБК-Україна"
  - "оглядова стаття, The American Journal of Medicine, 2025"
  - "повний текст"
  - ""
  - ""
  - ""
...
source_descriptions:
  - "Рандомізоване подвійне сліпе РКД STEP 1 (1 961 доросла особа без діабету, 68 тижнів): семаглутид дав мінус 14,9% ваги проти мінус 2,4% на плацебо."
  - "РКД STEP 5 (304 учасники, 104 тижні): мінус 15,2% ваги проти мінус 2,6% на плацебо — ефект тримається два роки, поки препарат приймають."
  - "РКД SELECT (17 604 пацієнти з наявною серцево-судинною хворобою, ~40 місяців): серйозні серцеві події у 6,5% проти 8,0% — відносне зниження на 20%."
  - "Продовження STEP 1 після відміни препарата: більшість втраченої ваги повертається протягом року без лікування."
  - "Мета-регресія в eClinicalMedicine/The Lancet: кількісно оцінює темп повернення ваги після припинення терапії GLP-1."
  - "Мета-аналіз в International Journal of Obesity: частина втраченої маси припадає на м'язову тканину, а не лише на жир."
  - "Мережевий мета-аналіз у Diabetes, Obesity and Metabolism: порівнює препарати за впливом на склад тіла (жирова vs нежирова маса)."
  - "Оглядова стаття в The American Journal of Medicine: механізм дії GLP-1 — гіпоталамус (насичення), шлунок (сповільнене спорожнення), підшлункова (інсулін, глюкагон)."
  - "Огляд комітету PRAC Європейського агентства з лікарських засобів: NAION визнано дуже рідкісним побічним ефектом семаглутиду."
  - "Сигнальний алерт ВООЗ щодо ризику NAION (неартеріїтної передньої ішемічної оптичної нейропатії) у користувачів GLP-1."
  - "Настанова ВООЗ 2025 року щодо застосування препаратів GLP-1 при ожирінні у дорослих."
  - "Перелік основних лікарських засобів ВООЗ — включення/розгляд GLP-1 як базової терапії."
  - "Матеріали FDA: схвалені показання, попередження в інструкції та дані про дефіцит і компаундовані версії препарату."
  - "Опитування KFF Health Tracking Poll: поширеність застосування GLP-1 серед дорослих США, мотиви та бар'єри вартості."
  - "Опитування Gallup 2026: 12,4% дорослих США приймають GLP-1 для схуднення; частка ожиріння впала з 39,9% (2022) до 36,4%."
  - "Обсерваційне дослідження (JAMA Network Open / PMC): реальна практика застосування, прихильність до терапії та результати поза межами РКД."
  - "Аналітика Truveta Research на масиві електронних медичних карток: як довго пацієнти реально залишаються на препараті та скільки ваги втрачають."
  - "Публікація Healio — медичне галузеве видання, огляд клінічних новин і коментарів фахівців щодо GLP-1."
  - "Державний реєстр лікарських засобів України: перевірка офіційної реєстрації семаглутиду та доступних форм в Україні."
  - "Матеріал LB.ua про ринок і доступність GLP-1 препаратів в Україні."
  - "Матеріал РБК-Україна про ціни, попит і підробки GLP-1 препаратів на українському ринку."
  - "Оглядова стаття The American Journal of Medicine (2025): узагальнення фізіології інкретинів і фармакології агоністів GLP-1."
  - "Повний текст цитованої публікації — першоджерело для перевірки наведених цифр."
  - "Джерело без опису у вихідному списку."
  - "Джерело без опису у вихідному списку."
  - "Джерело без опису у вихідному списку."
  - "Джерело без опису у вихідному списку."
---
