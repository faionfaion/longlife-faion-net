...
**Чесний нюанс:** експеримент Laborde et al. 2022 (112 учасників, *Psychophysiology*) показав, що дихання 6/хв **без** біофідбеку дає майже такий самий приріст RMSSD (метрика HRV, що відображає парасимпатичну активність) і зниження збудження, як із ним ([onlinelibrary.wiley.com](https://onlinelibrary.wiley.com/doi/10.1111/psyp.13952)). Прилад допомагає передусім тримати правильний темп і мотивує не кидати.

**Залізо.** Найточніше — нагрудний ремінь Polar H10 + застосунок Elite HRV: валідація Vondrasek 2023 у *Sensors* показала LCC=0.92 для SDNN проти ЕКГ ([pmc.ncbi.nlm.nih.gov](https://pmc.ncbi.nlm.nih.gov/articles/PMC10708620/)). Apple Watch Series 9/Ultra 2 занижує HRV приблизно на 8.3 мс ([mdpi.com](https://www.mdpi.com/1424-8220/24/19/6220)) — для пейсингу згодиться, для точних метрик — ні.

Спортсменам теж цікаво: Bayesian мета-аналіз 2025 (41 РКД, 1230 атлетів) знайшов SMD=0.88 для продуктивності, але з дуже низькою достовірністю за GRADE ([pmc.ncbi.nlm.nih.gov](https://pmc.ncbi.nlm.nih.gov/articles/PMC12583207/)).
