...
- "https://www.who.int/campaigns/world-amr-awareness-week"
source_names:
  - "десятки найбільших загроз здоров'ю людства"
  - "4,95 мільйона смертей були пов'язані з бактеріальною антибіотикорезистентністю"
  - "від АМР безпосередньо загинуть 39 мільйонів людей"
  - "глобальна поширеність самолікування антибіотиками - 43%"
  - "приблизно кожен другий українець купував антибіотики без рецепта лікаря"
  - "46% українців застосовували антибіотики при гострих респіраторних інфекціях"
  - "лише за електронним рецептом"
  - "60% із них були спричинені карбапенем-резистентними організмами"
  - "EARS-Net (ECDC)"
  - "лише близько 30% бактерій реагували на призначені антибіотики"
  - "ВООЗ попереджає"
  - "52–100% респіраторних інфекцій отримують антибіотики"
  - "CDC"
  - "немає достатніх доказів"
