...
Питати в кабінеті «чи є у вас журнал температури» я не раджу — це виглядає як недовіра до людини, яка ні в чому не винна. Але якщо в районі щойно були тривалі відключення, запитати, чи вакцина зберігалася за протоколом, цілком нормально. Про зберігання решти ліків до 25 °C я писала в [чеклісті на спеку і блекаут](https://longlife.media/nhs-heat-action-plan-ukhsa-4-rivni-ukraina-blekaut-cheklist-2026/).
