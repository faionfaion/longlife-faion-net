...
source_descriptions:
  - "Перша фаза випробування SPVX02 (вакцина проти правця й дифтерії без холодильника): рандомізоване односліпе, 60 дорослих, по 20 на групу; на 28-й день усі в групі SPVX02 досягли захисного рівня антитоксину"
  - "Огляд незалежних експертів щодо SPVX02: малі групи, 28 днів спостереження, ~95% білих учасників, дані стабільності лабораторні; спека в цільових країнах вища за 30 °C"
  - "Систематичний огляд 35 досліджень: випадкове замерзання трапляється на всіх ділянках холодового ланцюга (14–35% холодильників/партій, 75–100% на повному шляху)"
  - "Огляд через десять років: проблема замерзання вакцин не зникла, частина причини — персонал не знає, що заморожена вакцина зіпсована"
  - "Валідація shake test: подвійне засліплення, 475 флаконів, 8 вакцин, 10 виробників; чутливість і специфічність 100% проти фазово-контрастної мікроскопії"
  - "Пояснює механізм незворотної шкоди: замерзання спричиняє агрегацію алюмінієвого ад'юванта й випадіння осаду, потенція не відновлюється"
  - "Довідник з вакцинації: вимоги до зберігання й температурних режимів, чутливість адсорбованих вакцин до заморожування"
  - "Наказ МОЗ України № 1682 — національні вимоги до холодового ланцюга та зберігання вакцин"
  - "Галузеве видання; джерело українського контексту про обіг і зберігання вакцин"
  - "Нормативні показники втрат ВООЗ (5–50% залежно від фасування) — припущення для планування закупівель, а не вимір реальних втрат"
  - "Аналіз Duke Global Health Innovation Center: реальні втрати під час COVID-кампаній були значно нижчі за 50%, глобальних даних бракує"
  - "Екологічний звіт ООН, який переказує оцінку ВООЗ 2005 року про «до 50%» втрачених вакцин"
  - "Публікація, що тиражує ту саму цифру 50% без перевірки первинного джерела"
  - "Моніторингова місія ООН з прав людини в Україні: дані про наслідки атак на інфраструктуру, зокрема знеструмлення"
  - "Джерело не вказано"
---
...
2. **Після тривалого блекаута в районі - спокійно запитайте, чи дотримано температурного режиму.** Ви маєте на це право: наказ МОЗ № 1682 зобов'язує заклад вести моніторинг і повідомляти про інциденти протягом 3 годин. Формулювання «чи все гаразд зі зберіганням після відключень?» працює краще за перевірку журналу.
3. **Shake test не робіть самі.** Це процедура для медпрацівника, вона потребує еталонного флакона й стосується лише вакцин з алюмінієвим ад'ювантом (Kartoglu et al., 2010; PAHO/ВООЗ).
