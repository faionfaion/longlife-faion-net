---
title: "«Половина вакцин у смітник»: звідки ця цифра — і чому головна загроза холодового ланцюга не спека, а мороз"
slug: "vakcyny-kholodovyi-lantsiuh-moroz-shake-test-spvx02-popravka"
date: "2026-08-08"
type: "research"
lang: "ua"
tags:
...
source_urls:
  ...
  - "https://pubmed.ncbi.nlm.nih.gov/20680128/"
  - "https://www.paho.org/en/documents/how-perform-shake-test-ja2010-04"
  ...
  - "https://moz.gov.ua/storage/uploads/b9963177-8cb1-4c47-b6a2-a8c38db806ad/%D0%9F%D0%BE%D1%80%D1%8F%D0%B4%D0%BE%D0%BA-01.08.pdf"
  - "https://www.apteka.ua/article/707954"
  - "https://www.who.int/docs/default-source/immunization/tools/revising-wastage-concept-note.pdf"
  - "https://launchandscalefaster.org/looking%20into%20vaccine%20wastage"
  - "https://www.unep.org/news-and-stories/story/why-optimized-cold-chains-could-save-billion-covid-vaccines"
  - "https://www.weforum.org/stories/2018/07/the-biggest-hurdle-to-universal-vaccination-might-just-be-a-fridge/"
...
source_names:
  - "eClinicalMedicine (Lancet Discovery Science)"
  - "Science Media Centre"
  - "Vaccine (Matthias et al., 2007)"
  - "Vaccine (Hanson et al., 2017)"
  - "Bulletin of the World Health Organization (Kartoglu et al., 2010)"
  - "PAHO/WHO"
  - "CDC Pink Book"
  - "МОЗ України, наказ № 1682"
  - "Аптека online"
  - "WHO — Global Indicative Wastage Rates"
  - "Duke Launch & Scale Speedometer"
  - "UNEP"
  - "World Economic Forum"
  - "UN Human Rights Monitoring Mission in Ukraine"
image: "/images/vakcyny-kholodovyi-lantsiuh-moroz-shake-test-spvx02-popravka.jpg"
tg_post: |
  <b>Цифра «половина вакцин іде у смітник» — це оцінка ВООЗ 2005 року, і вона взагалі не про холод</b>
  
  У ті 50% зашиті відкриті флакони, прострочення й помилки складського обліку — температурні втрати лише частина. Нормативні 5–50% ВООЗ — це припущення для планування закупівель, а не вимір: Duke Global Health Innovation Center прямо пише, що реальні втрати під час COVID-кампаній були значно нижчі. Що справді нове — 5 серпня в eClinicalMedicine вийшла перша фаза випробування SPVX02, вакцини проти правця й дифтерії, якій не потрібен холодильник.
  
  <a href="https://longlife.faion.net/vakcyny-kholodovyi-lantsiuh-moroz-shake-test-spvx02-popravka/">Читати повністю →</a>
  
  <a href="https://t.me/long_life_media">🌿 LongLife Media</a>
---

Category: Громадське здоров'я
Tags: вакцинація, холодовий ланцюг, громадське здоров'я, Україна, блекаути

Два дні тому я написала тут текст про fridge-free вакцини — [«Холодильник не потрібен»](https://longlife.faion.net/fridge-free-vakcyny-cold-chain-blackouts-ukraine-2026/) — і повторила в ньому цифру, яка ходить усіма заголовками: до 50% вироблених у світі вакцин не доходить до людини. Я взяла її з галузевого джерела й не перевірила походження. Перевірила зараз. Мушу поправити себе — і заразом переписати те, що вважала головним ризиком.

## Цифра 50% — це оцінка 2005 року, і вона не про холод

Слід веде до оцінки ВООЗ приблизно двадцятирічної давнини, яку відтоді переказують [UNEP](https://www.unep.org/news-and-stories/story/why-optimized-cold-chains-could-save-billion-covid-vaccines) і [WEF](https://www.weforum.org/stories/2018/07/the-biggest-hurdle-to-universal-vaccination-might-just-be-a-fridge/). Вона складається з усього одразу: відкриті флакони, які не використали до кінця зміни, прострочення, помилки складського обліку. Втрати через температуру — лише частина.

Більше того, [нормативні показники ВООЗ](https://www.who.int/docs/default-source/immunization/tools/revising-wastage-concept-note.pdf) (5–50% залежно від фасування) — це припущення для планування закупівель, а не вимір. Duke Global Health Innovation Center [прямо пише](https://launchandscalefaster.org/looking%20into%20vaccine%20wastage), що реальні втрати під час COVID-кампаній були значно нижчі за 50%, і що глобальних даних просто бракує.
...
У [eClinicalMedicine](https://doi.org/10.1016/j.eclinm.2026.104116) (Lancet Discovery Science) опублікували першу фазу випробування SPVX02 — переформульованої вакцини проти правця й дифтерії, яка не потребує холодильника. Рандомізоване односліпе дослідження (учасник не знає, який препарат отримує, дослідник знає), 60 здорових дорослих 18–55 років у Саутгемптоні, по **20 осіб на групу**.
...
Систематичний огляд [Matthias та співавторів (Vaccine, 2007)](https://pubmed.ncbi.nlm.nih.gov/17382434/), який включив 35 досліджень, показав: випадкове замерзання трапляється на кожному відрізку ланцюга. Від 14% до 35% холодильників чи партій піддавали вакцину температурам нижче нуля, а в дослідженнях, які відстежували весь шлях від складу до кабінету, — 75–100% партій. Що ретельніший дизайн дослідження, то більше замерзання воно знаходило. [Огляд Hanson та співавторів 2017 року](https://www.sciencedirect.com/science/article/pii/S0264410X16309471) підсумовує, що за десять років проблема нікуди не зникла, і що частина причини — персонал просто не знає, що заморожена вакцина зіпсована.

А зіпсована вона незворотно. Заморожування спричиняє агрегацію гелю гідроксиду або фосфату алюмінію: дрібні частинки ад'юванта злипаються у грубші, випадають в осад, і після відтавання потенція вакцини не повертається ([PAHO/ВООЗ](https://www.paho.org/en/documents/how-perform-shake-test-ja2010-04)). Це стосується АКДП, АДП-М, гепатиту B, ВПЛ — тобто саме того, що колють у ЦПМСД.
...
Щодо «переколоти»: [CDC у Pink Book](https://www.cdc.gov/pinkbook/hcp/table-of-contents/chapter-5-vaccine-storage-and-handling.html) не радить викидати флакони одразу — їх маркують «НЕ ВИКОРИСТОВУВАТИ», ізолюють і узгоджують долю з виробником. А якщо скомпрометовану дозу вже ввели, її, як правило, [потрібно повторити](https://www.cdc.gov/vaccines/hcp/admin/storage/downloads/temperature-excursion-508.pdf). Рішення ухвалює лікар, не пацієнт і не я.

## Український контекст

Правила в нас суворіші, ніж я думала. [Наказ МОЗ від 02.10.2024 № 1682](https://moz.gov.ua/storage/uploads/b9963177-8cb1-4c47-b6a2-a8c38db806ad/%D0%9F%D0%BE%D1%80%D1%8F%D0%B4%D0%BE%D0%BA-01.08.pdf) вимагає дистанційного електронного моніторингу температури з автоматичним сповіщенням, ручного запису двічі на добу включно з вихідними, термоконтейнерів, які тримають 2–8 °C щонайменше 24 години за зовнішніх +43 °C, і — це головне для нас — **повідомлення до центру контролю хвороб протягом 3 годин** у разі надзвичайної ситуації, що загрожує температурному режиму. Ці чотири цифри я звіряла безпосередньо з текстом Порядку в PDF; точну нумерацію пунктів наводити не беруся, бо файл на сайті МОЗ оновлювався, і номер, який я процитую сьогодні, може не збігтися з чинною редакцією — перевіряйте за PDF за посиланням. [Розбір в «Аптеці»](https://www.apteka.ua/article/707954) звертає увагу на прогалину: резервні потужності холодильників наказ передбачає, а генератори — ні.

З огляду на [задокументовані ООН системні удари по енергетиці](https://ukraine.ohchr.org/en/Attacks-against-Ukraine-s-energy-infrastructure-and-update-on-the-human-rights-situation-in-Ukraine-1-December-2025-31-May-2026) і загальнонаціональні відключення січня 2026-го це не дрібниця. Хоча парадокс у тому, що знеструмлений холодильник радше нагріється, ніж заморозить, — а от переохолодження дає саме несправна або перевантажена морозильна камера, тобто звичайна щоденна експлуатація.

Питати в кабінеті «чи є у вас журнал температури» я не раджу — це виглядає як недовіра до людини, яка ні в чому не винна. Але якщо в районі щойно були тривалі відключення, запитати, чи вакцина зберігалася за протоколом, цілком нормально. Про зберігання решти ліків до 25 °C я писала в [чеклісті на спеку і блекаут](https://longlife.faion.net/nhs-heat-action-plan-ukhsa-4-rivni-ukraina-blekaut-cheklist-2026/).

## Що з цим робити

1. **Не відкладайте щеплення через цей текст.** Ризик від невакцинованості значно конкретніший за ризик отримати дозу, зіпсовану морозом. Все, про що тут ішлося, — це аргумент за контроль зберігання, а не проти вакцинації.
2. **Після тривалого блекаута в районі — спокійно запитайте, чи дотримано температурного режиму.** Ви маєте на це право: [наказ МОЗ № 1682](https://moz.gov.ua/storage/uploads/b9963177-8cb1-4c47-b6a2-a8c38db806ad/%D0%9F%D0%BE%D1%80%D1%8F%D0%B4%D0%BE%D0%BA-01.08.pdf) зобов'язує заклад вести моніторинг і повідомляти про інциденти протягом 3 годин. Формулювання «чи все гаразд зі зберіганням після відключень?» працює краще за перевірку журналу.
3. **Shake test не робіть самі.** Це процедура для медпрацівника, вона потребує еталонного флакона й стосується лише вакцин з алюмінієвим ад'ювантом ([Kartoglu et al., 2010](https://pubmed.ncbi.nlm.nih.gov/20680128/); [PAHO/ВООЗ](https://www.paho.org/en/documents/how-perform-shake-test-ja2010-04)).

І головне: чи потрібно повторювати конкретну дозу, вирішує лікар — за протоколом виробника й рекомендаціями щодо температурних відхилень ([CDC](https://www.cdc.gov/vaccines/hcp/admin/storage/downloads/temperature-excursion-508.pdf)), а не стаття в інтернеті.
