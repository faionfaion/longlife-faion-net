...
source_names:
  - "UNEP"
  - "WEF"
  - "нормативні показники ВООЗ"
  - "прямо пише"
  - "eClinicalMedicine"
  - "незалежні експерти в огляді Science Media Centre"
  - "Matthias та співавторів (Vaccine, 2007)"
  - "Огляд Hanson та співавторів 2017 року"
  - "PAHO/ВООЗ"
  - "Валідаційне дослідження Kartoglu та співавторів (Bulletin of the WHO, 2010)"
  - "CDC у Pink Book"
  - "потрібно повторити"
  - "Наказ МОЗ від 02.10.2024 № 1682"
  - "Розбір в «Аптеці»"
  - "задокументовані ООН системні удари по енергетиці"
