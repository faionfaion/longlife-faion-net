...
tg_post: |
  ...
  <a href="https://longlife.faion.net/bruksyzm-son-stres-apnoe-ne-prykus-likuvannia/">Читати повністю →</a>
...
- **Партнер чує скрегіт + ти хропиш або вдень засинаєш у транспорті** → перший крок не до стоматолога, а до сімейного лікаря чи сомнолога. Як ми писали в [гайді про обструктивне апное та STOP-BANG](https://longlife.faion.net/obstruktyvne-apnoe-snu-stop-bang-diagnostyka-likuvannia/), скринінг займає п'ять хвилин і може змінити весь план лікування.
...
- **Постійна тривога, керована тільки кавою** → варто пройти скринінг за GAD-7, як ми описували в [статті про тривожний розлад у дорослих](https://longlife.faion.net/gad-7-tryvozhnyi-rozlad-skryninh-cbt-ssri-ukraina/).
...
3. **Якщо є хропіння або денна сонливість** — пройди скринінг STOP-BANG за [нашим гайдом про апное](https://longlife.faion.net/obstruktyvne-apnoe-snu-stop-bang-diagnostyka-likuvannia/), перш ніж купувати капу.
4. **Прибери очевидні підсилювачі ввечері:** каву після 14:00 (про це ми писали в [матеріалі про кофеїн і сон](https://longlife.faion.net/caffeine-sleep-architecture-cyp1a2-deep-sleep-guide/)), алкоголь «для розслаблення» ([деталі тут](https://longlife.faion.net/alcohol-sleep-rem-disruption-hrv-guide/)), важку їжу й тренування за 3 години до сну.
