...
source_descriptions:
  - "Проспективна когорта (Wisconsin Sleep Cohort, 767 дорослих, медіана 8 років): безсоння з об'єктивно коротким сном за полісомнографією дало HR 2.57 (95% ДІ 1.12–5.89) для смертності від усіх причин, а з суб'єктивно коротким — значущого зв'язку не виявили."
  - "Мета-аналіз 10 статей / 12 когорт серед жінок із переважно самозвітною тривалістю сну: недостатній сон пов'язаний із гіпертензією (RR 1.10; 95% ДІ 1.06–1.13), довгий сон — ні (RR 1.00; 0.96–1.05)."
  - "Спостережне дослідження 95 819 учасників за підматрацними сенсорами (~20 місяців): хронічно нерегулярний сон — на 8% нижча ефективність сну, +40 хв неспання після засинання, на 46% вищі шанси гіпертензії, і нерегулярність закріплюється як стійкий стан."
  - "Дослідження в JAMA Network Open (Juginovic, Rodman) — четверте джерело тижневого зрізу; повний зміст у наданому фрагменті статті не розкрито."
  - "Редакційна стаття в JAMA Network Open, що коментує відповідну публікацію того ж номера; деталі у фрагменті не наведено."
  - "Мета-аналіз рандомізованих досліджень терапії прийняття та відповідальності (ACT) при порушеннях сну; конкретні оцінки ефекту у фрагменті не наведено."
  - "Рандомізоване контрольоване дослідження для змінних працівників (Scientific Reports); зміст втручання та результати у фрагменті не розкрито."
  - "Мета-аналіз аеробних вправ як втручання для покращення сну (Medicine, Baltimore); числові оцінки у фрагменті не наведено."
  - "Мета-аналіз водної термотерапії (теплі ванни/душ) та її впливу на сон; результати у фрагменті не деталізовано."
  - "The Human Sleep Project у SLEEP — масштабна ініціатива зі збору й стандартизації даних про сон; подробиці у фрагменті не розкрито."
  - "Дослідження SONAR у SLEEP: оцінка сну за допомогою смартгодинників — валідація носимого вимірювання проти еталонних методів; деталі у фрагменті не наведено."
---
