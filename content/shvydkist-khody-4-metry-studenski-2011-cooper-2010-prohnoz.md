...
source_descriptions:
  - "Об'єднаний аналіз індивідуальних даних 9 когорт (34 485 осіб 65+); кожні +0,1 м/с швидкості ходи — приблизно на 12% нижча смертність (HR 0,88)."
  - "Мета-аналіз проспективних досліджень чотирьох функціональних тестів; найсильніший предиктор смертності — швидкість ходи (HR 2,87), далі вставання зі стільця й сила хвату; дані про баланс об'єднати не вдалося."
  - "Огляд порогових значень швидкості ходи; універсальної межі немає — оптимальний поріг залежить від популяції й коливається від 0,3 до 1,0 м/с."
  - "Рекомендації ВООЗ з фізичної активності: людям 65+ — багатокомпонентна активність з акцентом на функціональний баланс і силу щонайменше 3 дні на тиждень."
  - "Бразильська когорта: нездатність простояти 10 секунд на одній нозі пов'язана з вищою смертністю в людей середнього й старшого віку."
  - "Продовження бразильської когорти Араужо: тест балансу на одній нозі як маркер функціонального старіння й ризику смерті."
  - "Оглядова робота про швидкість ходи як «функціональний життєвий показник»; градація ризику: ≥1,0 м/с — низький, 0,6–1,0 м/с — контекстний, ≤0,6 м/с — привід звернутися до лікаря."
  - "Кокранівський огляд вправ для профілактики падінь у літніх людей, які живуть самостійно; частота падінь знижується — коефіцієнт 0,77 (95% ДІ 0,71–0,83)."
---
