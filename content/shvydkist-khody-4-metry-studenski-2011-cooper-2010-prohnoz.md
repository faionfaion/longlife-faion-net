...
tg_post: |
  ...
  <a href="https://longlife.media/shvydkist-khody-4-metry-studenski-2011-cooper-2010-prohnoz/">Читати повністю →</a>
...
Ми вже писали, що в мета-аналізах кроків [темп ходьби додавав менше користі, ніж загальний обсяг](https://longlife.media/7000-krokiv-vs-10000-meta-analiz-smertnist-vik/). Це інша річ: там ідеться про каденс (кількість кроків за хвилину) під час звичайної прогулянки, тут — про стандартизований тест звичної швидкості на короткій дистанції. Один вимірює тренувальне навантаження, другий — функціональний резерв. 🔬
...
Два нюанси. Перший: баланс — єдиний із чотирьох, чиї результати автори не змогли звести в одну оцінку, і не всі асоціації там були статистично значущими. Це трохи послаблює наш [матеріал про 10 секунд на одній нозі](https://longlife.media/balance-test-10-seconds-one-leg-stand-mortality-fall-prevention/) — сам зв'язок у бразильській когорті лишається, але метааналітична база під ним тонша.
...
Окремо про кістки ми писали [в гайді про остеопороз у чоловіків 65+](https://longlife.media/osteoporoz-choloviky-65-plus-uspstf-frax-dexa-guide/) — там про скринінг і оцінку ризику переломів.
